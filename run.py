...
class Simulation:
    ...
    def run(self):
        ...
        while self.running:
            self.clock.tick(50)
            keys, velocities, localization = self.update(delta_t)
    ...
    def update(self, delta_t):
        ...
        velocities = self.robot.move(movement, delta_t, self.outer_wall)

        localization = self.Kalman

        return movement, velocities, localization
